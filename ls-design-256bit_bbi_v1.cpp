...
uint8_t SBox[256] = {0x20, 0x8D, 0xB2, 0xDA, 0x33, 0x35, 0xA6, 0xFF, 0x7A, 0x52, 0x6A, 0xC6, 0xA4, 0xA8, 0x51, 0x23,
...
void table_lbox(uint8_t *state){
  ...
  for(int i=0; i<4; i++){
    ...
    s[0] = l[0] ^ l[2] ^ l[3] ^ l[4] ^ l[5] ^ l[6] ^ xtime(l[2] ^ l[3] ^ l[5] ^ l[6]) ^ xtime(xtime(l[3] ^ l[4] ^ l[5])) ^ xtime(xtime(xtime(l[1] ^ l[3] ^ l[5] ^ l[7])));
    s[1] = l[1] ^ l[2] ^ l[4] ^ l[7] ^ xtime(l[2] ^ l[3] ^ l[7]) ^ xtime(xtime(l[1] ^ l[5] ^ l[6] ^ l[7])) ^ xtime(xtime(xtime(l[0] ^ l[1] ^ l[7])));
    s[2] = l[0] ^ l[1] ^ l[2] ^ l[3] ^ l[5] ^ l[7] ^ xtime(l[0] ^ l[2] ^ l[5] ^ l[6]) ^ xtime(xtime(l[0] ^ l[2] ^ l[4] ^ l[6] ^ l[7])) ^ xtime(xtime(xtime(l[0] ^ l[1] ^ l[2] ^ l[3] ^ l[5])));
    s[3] = l[0] ^ l[1] ^ l[3] ^ l[4] ^ xtime(l[2] ^ l[4] ^ l[5]) ^ xtime(xtime(l[0] ^ l[2] ^ l[6])) ^ xtime(xtime(xtime(l[3] ^ l[4] ^ l[7])));
    s[4] = l[1] ^ l[3] ^ l[4] ^ l[6] ^ xtime(l[2] ^ l[3] ^ l[4] ^ l[5]) ^ xtime(xtime(l[3] ^ l[4])) ^ xtime(xtime(xtime(l[0] ^ l[1] ^ l[2] ^ l[5] ^ l[6] ^ l[7])));
    s[5] = l[3] ^ l[4] ^ l[6] ^ l[7] ^ xtime(l[2] ^ l[3] ^ l[5]) ^ xtime(xtime(l[1] ^ l[5] ^ l[7])) ^ xtime(xtime(xtime(l[0] ^ l[3] ^ l[4])));
    s[6] = l[0] ^ l[2] ^ l[4] ^ l[5] ^ l[6] ^ l[7] ^ xtime(l[1] ^ l[2] ^ l[5] ^ l[7]) ^ xtime(xtime(l[0] ^ l[1] ^ l[3] ^ l[5] ^ l[7])) ^ xtime(xtime(xtime(l[2] ^ l[4] ^ l[5] ^ l[6] ^ l[7])));
    s[7] = l[0] ^ l[3] ^ l[5] ^ l[6] ^ xtime(l[0] ^ l[4] ^ l[5]) ^ xtime(xtime(l[0] ^ l[1] ^ l[2] ^ l[6])) ^ xtime(xtime(xtime(l[0] ^ l[6] ^ l[7])));
...
void table_sbox_layer(uint8_t* state) {
  for(int i=0; i<4; i++){state[i] = SBox[state[i]];}
}
...
void add_rc(uint32_t state[LS_ROWS], int round) {
  for (int i = 0; i < LS_ROWS; i++) {
    state[i] ^= shadow_rc[round][i];
  }
}

void add_drc(uint32_t state[LS_ROWS], int round) {
  for (int i = 0; i < LS_ROWS; i++) {
    state[i] ^= shadow_drc[round][i];
  }
}
